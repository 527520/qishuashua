...
import com.wqa.qishuashua.config.WxOpenConfig;
import com.wqa.qishuashua.model.dto.user.UserAddRequest;
import com.wqa.qishuashua.model.dto.user.UserLoginRequest;
import com.wqa.qishuashua.model.dto.user.UserQueryRequest;
import com.wqa.qishuashua.model.dto.user.UserRegisterRequest;
import com.wqa.qishuashua.model.dto.user.UserUpdateMyRequest;
import com.wqa.qishuashua.model.dto.user.UserUpdateRequest;
...
public class UserController {
    ...
    public BaseResponse<Long> addUser(@RequestBody UserAddRequest userAddRequest, HttpServletRequest request) {
        ...
        user.setUserPassword(DigestUtils.md5DigestAsHex(("wqa" + "12345678").getBytes()));
